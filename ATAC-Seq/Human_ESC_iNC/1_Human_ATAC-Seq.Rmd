...
ESC_vs_D3 <- as.data.frame(dba.report(NC_dba, contrast = 1))
ESC_vs_D5 <- as.data.frame(dba.report(NC_dba, contrast = 2))
D3_vs_D5 <- as.data.frame(dba.report(NC_dba, contrast = 3))
D3_vs_D5 <- as.data.frame(dba.report(NC_dba, contrast = 4))
D3_vs_D5 <- as.data.frame(dba.report(NC_dba, contrast = 5))
D3_vs_D5 <- as.data.frame(dba.report(NC_dba, contrast = 6))
