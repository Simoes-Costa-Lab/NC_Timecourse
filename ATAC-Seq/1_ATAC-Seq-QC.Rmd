...
```{r creating db object, echo=TRUE}
...
export(late_enriched, con = "./Exports/late_enriched_all.bed", format= "BED")
export(early_enriched, con = "./Exports/early_enriched_all.bed", format= "BED")
...
```{bash computeMatrix and plotHeatmap}
#making heatmaps
...
```{bash replotting with color changes}
