...
DESeq2_Analyze("6", dds, genes.universe = genes.universe, Padj = 0.05, L2fc = 1, testMF = F, testBP = F, plotVolc = TRUE, labelPadj = 0.1)

NC6_NC16 <- DESeq2_Analyze(timepoint = "6", second_timepoint = "16", versusWE = F, dds, genes.universe = genes.universe, Padj = 0.05, L2fc = 1.5, testMF = F, testBP = F, plotVolc = TRUE, labelPadj = 1e-8)
NC6_NC16[[1]]
