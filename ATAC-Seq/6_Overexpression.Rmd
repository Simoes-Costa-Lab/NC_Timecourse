...
export(OE_regions_up, con = "./Exports/OE_regions_up.bed", format = "BED")

rlog(ATAC_OE)

heatmap_matrix = data.frame(
  Differential_matrix$Control1,
  Differential_matrix$Control2,
  Differential_matrix$OE1,
  Differential_matrix$OE2
)
colnames(heatmap_matrix) = c("Control1", "Control2", "OE1", "OE2")
View(Differential_matrix)
