...
#combined_df$percentage <- ifelse(combined_df$origin == "ESC", 100 * length(subset(combined_df, combined_df$origin == "ESC" & combined_df$hasTFAP2A == TRUE)[,1]) / length(subset(combined_df, combined_df$origin == "ESC")[,1]), 100 * length(subset(combined_df, combined_df$origin == "NC" & combined_df$hasTFAP2A == TRUE)[,1]) / length(subset(combined_df, combined_df$origin == "NC")[,1]))
