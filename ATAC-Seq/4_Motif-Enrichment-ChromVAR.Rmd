...
ggsave(filename = "Exports/Chick_NC_ATAC_chromVAR_Variability.eps", width = 8, height = 6)
tsne_dev <- deviationsTsne(dev, shiny = T, threshold = 1.5, perplexity = 4)
...
ggsave(file = "./Exports/Sox2_Oct4_chromVAR_noLegend.eps", device = "eps", width = 6, height = 4)
```
